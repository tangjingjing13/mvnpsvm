function lambda=ADMMfornonMVNPSVM(V,Paras,rho,p1,p2)
...
K11=kernel(AP,AP,'rbf',p1,p2);K12=kernel(AP,AN,'rbf',p1,p2);
K13=kernel(AN,AN,'rbf',p1,p2);
K21=kernel(BP,BP,'rbf',p1,p2);K22=kernel(BP,BN,'rbf',p1,p2);
K23=kernel(BN,BN,'rbf',p1,p2);
